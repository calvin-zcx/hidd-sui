...
if __name__ == '__main__':
    ...
    with open(featuredatafile, 'rb') as f:
        feat_data_1st_neg = pickle.load(f)
        print('len(feat_data_1st_neg):', len(feat_data_1st_neg))

    feat_dataset = Dataset(feat_data_1st_neg, diag_name=dx_name) #, diag_code_threshold=10)
    # my_dataset = Dataset(data_1st_neg, diag_name=dx_name)
    my_dataset = Dataset(data_1st_neg, diag_code_vocab=feat_dataset.diag_code_vocab)
