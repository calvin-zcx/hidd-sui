...
def results_summary(model='LR', data='apcd', encode='icd3d'):
    ...
    raux_95 = []
    for seed in range(0, 20):
        df = pd.read_csv('output/{}/{}/test_results_{}r{}.csv'.format(data, encode, model, seed))
    ...
    writer = pd.ExcelWriter('output/{}/{}/results_summary_{}.xlsx'.format(data, encode, model), engine='xlsxwriter')
...
if __name__ == '__main__':
    ...
    results_summary(model='LIGHTGBM', data='apcd', encode='icd3d')  #LIGHTGBM  apcd
    print('Done')
